...
Fee Rates & Different types of recommended fee rates (e.g., fastest fee) and confirmation targets. Fees are also binned by counts. & \begin{minipage}[t]{2cm} \vtop{\vbox{5 fee rates \\ 37 binned}} \end{minipage} & \begin{minipage}[t]{5cm}  \vtop{\vbox{Min: 1 sat/vbyte \\ Max: 41 sats/vbyte \\ Median: 2--3 sats/vbyte}} \end{minipage} \\
