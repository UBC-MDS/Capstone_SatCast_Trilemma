## Dataset Overview & Feature Preprocessing

We worked with a dataset of 5-minute snapshots from the Bitcoin mempool (March–May 2025), each containing 61 features describing real-time network conditions such as mempool congestion, transaction volume, block creation, mining difficulty, and BTC price. These features captured the main drivers of fee dynamics.
...
plt.hist(df['recommended_fee_fastestFee'], bins=50, color='steelblue', edgecolor='black')
plt.title("Original Distribution of fastestFee")
plt.xlabel("Fee (sats/vByte)")
