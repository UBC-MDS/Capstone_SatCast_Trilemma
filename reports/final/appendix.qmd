## Appendix A: Terminology {.unnumbered #sec-terminology}
...
\hline
Bitcoin Core & The reference implementation of the Bitcoin protocol. It is the official software used to run a full Bitcoin node, validate transactions, and maintain a copy of the entire blockchain. \\
\hline
...
\hline
Non-Fungible Token (NFT) & A unique digital asset stored on a blockchain that represents ownership of something like art, music, or collectibles. Unlike cryptocurrencies such as Bitcoin, NFTs are one-of-a-kind and cannot be exchanged on a one-to-one basis. \\
\hline
