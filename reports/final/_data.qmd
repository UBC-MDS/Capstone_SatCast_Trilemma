...
Our time series dataset consists of 61 features capturing mempool activity, transaction volume, block statistics, mining difficulty, BTC price, and other relevant indicators. To make these inputs more interpretable, we organized them into four high-level categories, as shown in @#tbl-features. Each category reflects a distinct dimension of network behavior or market condition relevant to fee dynamics
