...
def save_csv_data(data, file_path, index=False):
    ...
    data : pd.DataFrame or pd.Series
        The DataFrame or Series to be saved.
    file_path : str
    ...
    """
    # Check if data is a pandas DataFrame or Series
    if not isinstance(data, (pd.DataFrame, pd.Series)):
        raise TypeError("The `data` parameter must be a pandas DataFrame or Series.")
