...
"""
Forecast Bitcoin transaction fees using a pretrained Temporal Fusion Transformer (TFT) model.

This script loads a serialized TFT model using PyTorch, applies preprocessing to the input
data, makes predictions for the latest 96 time steps, and returns a forecast DataFrame along
with evaluation metrics. The prediction targets the 'recommended_fee_fastestFee' series.
