# sliding_window_daily_train.py
# author: Yajing Liu
# date: 2025-06-08

# Usage:
# python scripts/sarima/sliding_window_daily_train.py \
#     --data="./data/processed/sarima/preprocessed_sarima_15min.parquet" \
#     --results="./results/tables/sarima/sliding_window_daily_predictions.csv"
...
@click.option('--results', type=str, default="./results/tables/sarima/sliding_window_daily_predictions.csv", help="Path to save results CSV")
def main(data, results):
    """
    Performs SARIMA sliding window forecasting (daily) and saves evaluation metrics.
    """
