# expanding_window_weekly_train.py
# author: Yajing Liu
# date: 2025-06-08
...
@click.option('--results', type=str, default="./results/tables/sarima/expanding_window_weekly_predictions.csv", help="Path to save results CSV")
def main(data, results):
    """
    Performs SARIMA expanding window forecasting (weekly) and saves evaluation metrics.
    """
    ...
    # Define forecasting horizon (1 week = 96 * 7 steps)
    fh = list(range(1, 96 + 1))  # 1 day horizon for each week

    # Expanding window splitter (weekly)
